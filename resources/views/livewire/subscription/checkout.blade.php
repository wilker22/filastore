<div>
    <div class="flex justify-center items-center w-full h-full absolute">
        ...
        <div class="checkoutForm w-96 p-10 bg-gray-900 border border-gray-400 rounded">
            ...
            <input id="card-holder-name" type="text" placeholder="Nome no Cartão" class="w-full mb-10 rounded px-6 py-3 border border-gray-600">

            <!-- Stripe Elements Placeholder -->
            <div id="card-element" class="border border-gray-500 px-8 py-4 rounded bg-white"></div>

            <button id="card-button" class="px-4 py-2 border border-green-800 bg-green-600 rounded text-white font-bold mt-10" data-secret="{{ $intent->client_secret }}">
                Realizar Assinatura
            </button>
